...
name: decision
description: >
  Document a decision with structured context, options, and rationale.
  Use when making project decisions, architecture choices, or strategic calls
  that you'll want to reference later.
