...
name: meeting-prep
description: >
  Prepare context for an upcoming meeting by gathering relevant history,
  open action items, and relationship context. Use when the user says
  "prep for my meeting with", "what should I know before my call with",
  "meeting prep", or asks to prepare for a specific person or meeting type.
