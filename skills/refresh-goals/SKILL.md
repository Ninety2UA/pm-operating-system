...
name: refresh-goals
description: >
  Review and fill gaps in GOALS.md through conversational questions.
  Use when GOALS.md has empty sections, quarterly for goal refresh,
  or when user asks to update goals, review priorities, or fill in their north star.
