...
description: >
  Researches and validates an existing project idea against market reality.
  Analyzes competitors, market size, social sentiment, and feasibility.
  Use when the user asks to "validate a project", "check if this idea is viable",
