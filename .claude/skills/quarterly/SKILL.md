...
model: inherit
effort: high
description: Run a 45-minute quarterly review — score OKRs against completion data, purge stale projects, preview and archive done tasks, review auto-created people pages, refresh GOALS.md, set new OKRs informed by past calibration, update Claude memories, audit AGENTS.md against the quarter's learnings, and save a quarterly summary. Use this skill whenever the user mentions quarterly review, end of quarter, OKR scoring, planning the next quarter, runs `/quarterly`, or says anything like "how did Q2 go," "time to plan Q3," "score the OKRs," "strategic refresh," or "end-of-quarter reflection." Push toward this at quarter boundaries even if the user doesn't explicitly ask.
...
1. Call `mcp__manager-ai__prune_completed_tasks` with the retention window and no `confirm`. Without it the tool previews: it moves nothing, creates nothing, and returns what it would archive.
