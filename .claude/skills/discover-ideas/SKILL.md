...
description: >
  ...
  across the user's goal domains. Use when the user asks to "find ideas",
  "discover opportunities", "what should I build", "scan for trends",
  "find trending topics", or wants fresh project inspiration.
  Accepts optional topic argument to narrow focus.
