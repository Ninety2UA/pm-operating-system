...
description: >
  ...
  Also use when the user brings one specific idea and asks whether to
  capture it, scope it, or evaluate it — the skill opens with a spike /
  bounded / architectural triage that lets small ideas skip the pipeline.
