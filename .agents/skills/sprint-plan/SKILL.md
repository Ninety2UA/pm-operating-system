...
Read the template at `references/sprint-plan-template.md` and fill each section from the tasks, stories, capacity, and selected sprint items gathered in Steps 2-4.
