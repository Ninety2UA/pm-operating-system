...
source_sha256: 58f62dd95e66426f75d0c4981f0ab0787cdd86da446e5d7ed6f840d8e90bf953
...
Check the arguments provided when you were invoked for a required `<project-name>`.
...
Read the template at `references/pre-mortem-template.md` and fill each section from the project context and failure scenarios generated in Step 5.
...
`references/anti-patterns.md` against the pre-mortem you
