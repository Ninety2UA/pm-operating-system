...
Check the arguments provided when you were invoked for an optional `--save` flag.
...
Read the template at `references/outcome-roadmap-template.md` and fill each section from the projects, goals, and outcomes gathered in Steps 2-3.
